...
#[derive(Debug)]
pub struct DeepOceanProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DeepOceanProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DeepOcean processing");
    
    let mut processor = DeepOceanProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DeepOceanProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DeepOceanProcessor::new(false);
